# SC-900 Quiz App — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build a portable, offline-capable SC-900 quiz app as two files (`index.html` + `questions.js`) that runs in any browser with no install or server.
...
| File | Responsibility |
|---|---|
| `questions.js` | Global `QUESTIONS` array — 60 SC-900 questions with options, answer index, and explanation |
...
git commit -m "feat: add SC-900 question bank (60 questions across 3 domains)"
```
...
<head>
  ...
  <title>SC-900 Quiz — Security, Compliance, and Identity Fundamentals</title>
  <style>
    :root {
      --blue: #0078D4;
      --blue-dark: #005a9e;
  ...
  <div id="screen-home" class="screen">
    <div class="container">
      <div class="app-header">
        ...
        <h1>SC-900 Quiz</h1>
        <p class="tagline">Microsoft Security, Compliance, and Identity Fundamentals</p>
      </div>
...
- Page loads with a cloud icon, "SC-900 Quiz" title, and "Start Quiz" button
